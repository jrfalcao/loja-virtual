    ...
    if(pgCode == "CREDIT_CARD"){
        PagSeguroDirectPayment.getPaymentMethods({
            ...
            success : function(json){
                ...
                var cDisponiveis = ['VISA', 'MASTERCARD', 'AMEX', 'ELO', 'HIPERCARD'];
                var html = '';
                for(var i in cDisponiveis){
                    if(cartoes[cDisponiveis[i]].status=="AVAILABLE"){
                        html += '<img onclick="selecionarBandeira(this);" data-bandeira="'+cartoes[cDisponiveis[i]].name+'" src="https://stc.pagseguro.uol.com.br'+cartoes[cDisponiveis[i]].images.MEDIUM.path+'" ';
                        html += 'alt="https://stc.pagseguro.uol.com.br'+cartoes[cDisponiveis[i]].images.MEDIUM.path+'" >';
                    }
                }
...
function selecionarBandeira(obj){
    ...
    PagSeguroDirectPayment.getInstallments({
        ...
        success:function(json){
            ...
            for(var i in p){
                var juros = (p[i].interestFree === true) ? "sem juros" : "com juros";
